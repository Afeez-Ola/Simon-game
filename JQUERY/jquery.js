/*! jQuery v3.5.1 | (c) JS Foundation and other contributors | jquery.org/license */ !(function(e, t) {
    ...
    function le(e, t) {
        for (
            var n, r, i, o, a, s, u, l = [], c = 0, f = e.length; c < f; c++
                ...
                reliableTrDimensions: function() {
                    ...
                    return null == a &&
                        ((e = E.createElement('table')), (t = E.createElement(
                                ...
                                '1px'), (n.style.height = '9px'), re
                            .appendChild(e)
                            .appendChild(t)
                            .appendChild(n), (r = C.getComputedStyle(t)), (a =
                                3 < parseInt(r.height)), re.removeChild(e)), a;
                },
            }));
    })();
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = X(t),
                    ...
                    l = e.style;
                if (
                    (u || (t = Xe(s)), (a = S.cssHooks[t] || S.cssHooks[s]), void 0 ===
                        n)
                )
    ...
    S.fn.extend({
        ...
        dt[t] = function(e, t, n) {
            ...
            return n ||
                ((i = dt[o]), (dt[o] = r), (r = null != a(e, t, n) ? o : null), (dt[
                    o
                ] = i)), r;
        };
    });
    ...
    (Wt.href = Tt.href), S.extend({
        ...
        ajax: function(e, t) {
            ...
            if (
                (x.promise(T), (v.url = ((e || v.url || Tt.href) + '').replace(
                    Pt,
                    Tt.protocol + '//'
                )), (v.type =
                    t.method ||
            ...
            if (
                (v.data &&
                    ...
                    (v.data = S.param(v.data, v.traditional)), Bt(Rt, v, t, T), h)
            )
                return T;
            for (i in ((g = S.event && v.global) &&
                    ...
                    S.event.trigger(
                        'ajaxStart'
                    ), (v.type = v.type.toUpperCase()), (v.hasContent = !Ot.test(
                        v.type
                    )), (f = v.url.replace(qt, '')), v.hasContent ?
                    v.data &&
                    v.processData &&
                    0 ===
                    (v.contentType || '')
                    ...
                    ((o = v.url.slice(f.length)), v.data &&
                        ...
                        ((f += (Et.test(f) ? '&' : '?') + v.data), delete v.data), !1 ===
                        v.cache &&
                        ((f = f.replace(Lt, '$1')), (o =
                            (Et.test(f) ? '&' : '?') + '_=' + Ct.guid++ + o)), (v.url =
                            f + o)), v.ifModified &&
                    (S.lastModified[f] &&
    ...
    S.ajaxSetup({
        ...
        setOffset: function(e, t, n) {
            ...
            'static' === l &&
                ...
                t.using.call(e, f) :
                ('number' == typeof f.top && (f.top += 'px'), 'number' ==
                    typeof f.left && (f.left += 'px'), c.css(f));
        },
    }), S.fn.extend({
        offset: function(t) {
            if (arguments.length)
